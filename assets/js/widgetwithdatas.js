    ...
    jQuery(document).ready(function($) { 
		...
		$(".askbypoll-embed-poll").each(function(index){
			...
			if(alreadyVoted == 'true' && dataGiven == 'true'){
				...
				var jsonp_url = "https://www.askbypoll.com/results-embed-poll?dataStored="+dataGiven+"&alreadyVoted="+alreadyVoted+"&pollId="+pollId+"&age="+askbypollAge+"&gender="+askbypollGender+"&profession="+askbypollProfession+"&email="+askbypollEmail+"&votedSession="+votedSession+"&src="+location.href+"&callback=?";
				...
				$.getJSON(jsonp_url, function(data) {
					that.html(data.html);
					var check_if_voted_url = "https://www.askbypoll.com/vote-embed-poll?pollId="+pollId+"&alreadyVoted="+alreadyVoted+"&src="+location.href+"&callback=?";
		...
		$(".askbypoll-embed-poll").on( "click", ".askbypoll-button", function() {
			...
			if(askbypollAge.trim() == "" || askbypollGender == "notSelected" || askbypollProfession == "notSelected"){
				...
				var jsonp_url = "https://www.askbypoll.com/results-embed-poll?pollId="+pollId+"&age="+askbypollAge+"&gender="+askbypollGender+"&profession="+askbypollProfession+"&email="+askbypollEmail+"&votedSession="+votedSession+"&src="+location.href+"&callback=?";
				//var a = new Date();
