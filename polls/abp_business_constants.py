solution_caption = [
	{'enterprise' : {
		"caption": "Customer Satisfaction<br>Employee Satisfaction<br>Employee Engagement",
	...
	{'startups' : {
		"caption": "Market Validation<br>App / Website User Testing<br>Market Attractiveness",
	...
	{'NGOs' : {
		"caption": "Impact Assessment<br>Social Campaigns<br>Issue Sensitivity",
		"brief":" The work which the NGOs do for the Society is commendable. However, it is also important for them to understand the impact they are creating in the society and also understand the sensitivity of various issues through the lens of the people. Use the AskByPoll Products and Services to gather opinion from people at the click of a few buttons. This is how we can help –",
		"details": [
					"Offload Your Impact Assessment Development Requirement to our team",
					"Measure the Sensitivity of Issues by Campaigning with People outside your network",
					"Design Engaging  Campaigns To Generate Awareness",
					"Gain access to AskByPoll Respondent Community ",
					"Integrate with your existing systems",
					"Secure Data, Always Yours",
					"Get expert advice and 24/7 support any time you need"
	...
	{'publishers' : {
		...
		"details": [
					"Improving User Engagement by letting Consumers interact with Content",
					"Gather Public Opinion Easily and Use the Information for Content Creation",
					"Create Engaging Campaigns to Measure Public Sentiments on Interest Issues",
					"Improve Your Data Validation by Gathering Primary Consumer Data Easily",
					"Gain access to AskByPoll Respondent Community ",
					"Integrate with your existing systems",
					"Secure Data, Always Yours",
					"Get expert advice and 24/7 support any time you need"
	...
	{'FMCG' : {
		...
		"details": [
					"Closed User Group Quantitative & Qualitative Research",
					"Increase Customer Engagement Opinion Gathering on Products and Services",
					"Gather Planning & Preference Data from Target Group Customers",
					"Gain access to AskByPoll Respondent Community ",
					"Integrate with your existing systems",
					"Secure Data, Always Yours",
					"Get expert advice and 24/7 support any time you need"
	...
	{'others' : {
		"caption": "Meaningful Insights<br>Advanced Analysis<br>Meaningful Insights",
		"brief":" Did not find your industry here. Get in touch and we will work something out.",
		"details": [
					"Gather valuable data from customer feedback to product research",
					"Use advanced analytics to turn your data into smarter business decisions",
					"Create sophisticated surveys in minutes",
