...
urlpatterns = patterns('',
	...
	url(r'^vote/(?P<pk>\d+)/(?P<que_slug>[\w\-]+)/$',login_required(views.VoteView.as_view()),name='polls_vote'),
	...
	url(r'^follow/', login_required(views.FollowPollView.as_view()),name="polls_follow"),
)
